...
Este script convierte toda la música del directorio que damos como primer argumento a formato \emph{.m4a} o \emph{.mp3} en un mirror que replica al estructura del directorio original.
